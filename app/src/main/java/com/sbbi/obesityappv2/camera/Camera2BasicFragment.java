package com.sbbi.obesityappv2.camera;
...
public class Camera2BasicFragment  extends Fragment
    ...
    /**
     * Max preview height that is guarante ed by Camera2 API
     */
    ...
    private void takePicture() {
        ...
        //unlockFocus();
        //captureStillPicture();
        //Log.v("END","sequence has finished");
    }
    ...
    private static class ImageSaver implements Runnable {
        ...
        public void run() {
            ...
            try {
                byte resizedImage[] = resizeImage(bytes);
                output = new FileOutputStream(mFile);
                output.write(resizedImage);
            } catch (IOException e) {
                e.printStackTrace();
            } finally {
                mImage.close();
